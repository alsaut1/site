...
<form class="form form--add-lot container <?= $classname; ?>" action="add.php" method="post" enctype="multipart/form-data"> <!-- form--invalid -->
      ...
      <div class="form__container-two">
        ...
        <div class="form__item <?= $classname; ?>"> <!-- "form__item--invalid" -->
          ...
          <?php $content = isset($lot['lot-name']) ? ($lot['lot-name']) : "" ;?>
          <input id="lot-name" type="text" name="lot-name" placeholder="Введите наименование лота" value ="<?=$content;?>">
        ...
        <div class="form__item <?= $classname; ?>">
          ...
          <select id="category" name="category">
            ...
            <?php for ($i = 0; $i < count($categories); $i++): ?>
            <option value = "<?=$i+1; ?>"> <?=($categories[$i]['name']); ?></option>
              <?php endfor;?>
          </select>
      ...
      <div class="form__item form__item--wide <?= $classname; ?>">
        ...
        <?php $content = isset($lot['message']) ? ($lot['message']) : "Напишите описание лота" ;?>
      ...
      <div class="form__container-three">
        ...
        <div class="form__item form__item--small <?= $classname; ?>">
          ...
          <?php $content = isset($lot['lot-rate']) ? ($lot['lot-rate']) : "" ;?>
          <input id="lot-rate" type="text" name="lot-rate" placeholder="0" value ="<?= $content; ?>">
          <span class="form__error">Введите начальную цену</span>
        </div>
        <?php $classname = isset($errors["lot-step"]) ? "form__item--invalid" :""; ?>
        <div class="form__item form__item--small <?= $classname; ?>">
          <label for="lot-step">Шаг ставки <sup>*</sup></label>
          <?php $content = isset($lot['lot-step']) ? ($lot['lot-step']) : "" ;?>
          <input id="lot-step" type="text" name="lot-step" placeholder="0" value ="<?=$content;?>">
